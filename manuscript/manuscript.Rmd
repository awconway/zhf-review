...
Total word count: 3075 words

Introduction word count: 303 words

Discussion word count: 781 words
...
**Question:** How accurate are temperature measurements from zero-heat-flux temperature monitors?

**Findings:** Population limits of agreement, which take into consideration the between-study heterogeneity and sampling error, were wide, spanning from `r primary$CI_L_rve`°C to `r primary$CI_U_rve`°C.

**Meaning:** Zero-heat-flux temperature monitoring would not be appropriate if a difference in temperature of 1°C is important to detect for the given clinical situation.
...
Sixteen studies were included (Figure 1). Two studies reported only in abstract form were not included and assigned as 'studies awaiting classification' because there was insufficient information provided. 
